...
earthElev_deg = [(math.acos((r**2+num**2-(r+h)**2)/(2*num*r)))*180/3.14 for num in slantRange]
...
#plt.plot(Half_Cone_Angle,earthElev_deg)
...
for i in range(0, len(Half_Cone_Angle)):
    if ( target*0.95 < Half_Cone_Angle[i] < target*1.05 ):        stash_i = i;

print(slantRange[stash_i])
#print(CSLgain_PORT1[stash_i])
print('Theta at antenna:',90-Half_Cone_Angle[stash_i])
print('Elevation at earth:',earthElev_deg[stash_i]-90)
