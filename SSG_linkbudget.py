...
ISLPowerdBm = 33 # verified
#SatelliteAntGain = 0#dBi
CableLossdB = -2 # was -3
ChannelLossdB = -3 # Fading, interference and polarization
DataRate = 60 #dB/s @ 1Mbps
Noise = -202.7 # dBW/Hz
RadarAntGaindB = 30 # added by Claude afterward for verification

h = 1000.0 #km
r = 0.1 #km
flightangle = 60.0 # deg
...
LinkMargin = [ISLPowerdBm+CableLossdB+ChannelLossdB+RadarAntGaindB+num for num in PathlossdB] # No datarate and noise
